...
const DummyContent = ({ serviceType }) => {
    ...
    "Implementation": (
      <>
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800 dark:text-white mb-4">Oracle EPM Implementation Excellence</h2>
        </div>
        <div className="bg-[#F5F5F7] dark:bg-neutral-800 p-8 md:p-14 rounded-3xl mb-6">
          ...
          <ul className="mt-6 space-y-3 text-neutral-600 dark:text-neutral-400 text-base md:text-xl font-sans max-w-3xl mx-auto">
        ...
        <div className="bg-[#F5F5F7] dark:bg-neutral-800 p-8 md:p-14 rounded-3xl mb-6">
          ...
          <div className="mt-6 max-w-3xl mx-auto">
            <h3 className="font-bold text-neutral-700 dark:text-neutral-200 text-lg md:text-xl mb-3">Our 5-Phase Implementation Approach:</h3>
            <ol className="space-y-4 text-neutral-600 dark:text-neutral-400 text-base md:text-lg">
              <li className="flex">
                <span className="font-bold text-blue-600 dark:text-blue-400 mr-2">1.</span>
                <div>
                  <span className="font-semibold">Discovery & Planning</span> - Analyze current processes, define requirements, and develop project plan
                </div>
              </li>
              <li className="flex">
                <span className="font-bold text-blue-600 dark:text-blue-400 mr-2">2.</span>
                <div>
                  <span className="font-semibold">Design & Architecture</span> - Design application structure, data flows, integration points, and security model
                </div>
              </li>
              <li className="flex">
                <span className="font-bold text-blue-600 dark:text-blue-400 mr-2">3.</span>
                <div>
                  <span className="font-semibold">Build & Configure</span> - Develop custom applications, configure modules, and establish integrations
                </div>
              </li>
              <li className="flex">
                <span className="font-bold text-blue-600 dark:text-blue-400 mr-2">4.</span>
                <div>
                  <span className="font-semibold">Testing & Validation</span> - Execute unit tests, integration tests, user acceptance testing, and performance testing
                </div>
              </li>
              <li className="flex">
                <span className="font-bold text-blue-600 dark:text-blue-400 mr-2">5.</span>
                <div>
                  <span className="font-semibold">Deployment & Support</span> - Deploy to production, provide go-live support, and transition to ongoing maintenance
                </div>
              </li>
            </ol>
          </div>
        ...
        <div className="bg-[#F5F5F7] dark:bg-neutral-800 p-8 md:p-14 rounded-3xl mb-6">
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            <div className="bg-white dark:bg-neutral-700 p-6 rounded-xl shadow-sm">
              <h4 className="font-bold text-blue-600 dark:text-blue-400 text-lg mb-3">Planning & Budgeting</h4>
              <p className="text-neutral-600 dark:text-neutral-300">Streamline your planning cycles with automated workflows, driver-based forecasting, and scenario modeling capabilities.</p>
            </div>
            <div className="bg-white dark:bg-neutral-700 p-6 rounded-xl shadow-sm">
              <h4 className="font-bold text-blue-600 dark:text-blue-400 text-lg mb-3">Financial Consolidation</h4>
              <p className="text-neutral-600 dark:text-neutral-300">Accelerate your close process with automated consolidations, currency translations, and intercompany eliminations.</p>
            </div>
            <div className="bg-white dark:bg-neutral-700 p-6 rounded-xl shadow-sm">
              <h4 className="font-bold text-blue-600 dark:text-blue-400 text-lg mb-3">Account Reconciliation</h4>
              <p className="text-neutral-600 dark:text-neutral-300">Improve accuracy and compliance with automated account reconciliations, balance comparisons, and variance analysis.</p>
            </div>
            <div className="bg-white dark:bg-neutral-700 p-6 rounded-xl shadow-sm">
              <h4 className="font-bold text-blue-600 dark:text-blue-400 text-lg mb-3">Profitability Analysis</h4>
              <p className="text-neutral-600 dark:text-neutral-300">Gain insights into product, customer, and channel profitability with advanced allocation methodologies and cost modeling.</p>
            </div>
          </div>
        </div>
      </>
    ...
    "Financial Solutions": (
      <>
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800 dark:text-white mb-4">Strategic Financial Planning Solutions</h2>
        </div>
        <div className="bg-[#F5F5F7] dark:bg-neutral-800 p-8 md:p-14 rounded-3xl mb-6">
          <p className="text-neutral-600 dark:text-neutral-400 text-base md:text-2xl font-sans max-w-3xl mx-auto">
            <span className="font-bold text-neutral-700 dark:text-neutral-200">
          ...
          <div className="mt-6 bg-white dark:bg-neutral-700 p-6 rounded-xl max-w-3xl mx-auto">
            <h3 className="font-bold text-neutral-700 dark:text-neutral-200 text-lg md:text-xl mb-3">Key Benefits:</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-neutral-600 dark:text-neutral-300">
        ...
        <div className="bg-[#F5F5F7] dark:bg-neutral-800 p-8 md:p-14 rounded-3xl mb-6">
          ...
          <div className="mt-6 max-w-3xl mx-auto">
            <h3 className="font-bold text-neutral-700 dark:text-neutral-200 text-lg md:text-xl mb-3">Scenario Planning Capabilities:</h3>
            <ul className="space-y-3 text-neutral-600 dark:text-neutral-400">
              <li className="flex items-start">
                <span className="text-blue-600 dark:text-blue-400 mr-2">•</span>
                <div>
                  <span className="font-semibold">Multi-dimensional Modeling</span> - Create scenarios across any combination of business dimensions (products, regions, channels)
                </div>
              </li>
              <li className="flex items-start">
                <span className="text-blue-600 dark:text-blue-400 mr-2">•</span>
                <div>
                  <span className="font-semibold">Driver-based Forecasting</span> - Utilize business drivers to automatically cascade changes throughout your financial models
                </div>
              </li>
              <li className="flex items-start">
                <span className="text-blue-600 dark:text-blue-400 mr-2">•</span>
                <div>
                  <span className="font-semibold">Sensitivity Analysis</span> - Test how changes in key variables impact overall financial performance
                </div>
              </li>
              <li className="flex items-start">
                <span className="text-blue-600 dark:text-blue-400 mr-2">•</span>
                <div>
                  <span className="font-semibold">Monte Carlo Simulations</span> - Perform statistical analyses to evaluate risks and probabilities across multiple scenarios
                </div>
              </li>
            </ul>
          </div>
        ...
        <div className="bg-[#F5F5F7] dark:bg-neutral-800 p-8 md:p-14 rounded-3xl mb-6">
          ...
          <div className="mt-8 max-w-3xl mx-auto">
            <h3 className="font-bold text-neutral-700 dark:text-neutral-200 text-lg md:text-xl mb-4">Supported Integration Points:</h3>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              <div className="bg-white dark:bg-neutral-700 p-4 rounded-lg text-center shadow-sm">
                <p className="font-medium text-neutral-700 dark:text-neutral-200">Oracle ERP Cloud</p>
              </div>
              <div className="bg-white dark:bg-neutral-700 p-4 rounded-lg text-center shadow-sm">
                <p className="font-medium text-neutral-700 dark:text-neutral-200">Oracle NetSuite</p>
              </div>
              <div className="bg-white dark:bg-neutral-700 p-4 rounded-lg text-center shadow-sm">
                <p className="font-medium text-neutral-700 dark:text-neutral-200">SAP</p>
              </div>
              <div className="bg-white dark:bg-neutral-700 p-4 rounded-lg text-center shadow-sm">
                <p className="font-medium text-neutral-700 dark:text-neutral-200">Workday</p>
              </div>
              <div className="bg-white dark:bg-neutral-700 p-4 rounded-lg text-center shadow-sm">
                <p className="font-medium text-neutral-700 dark:text-neutral-200">Salesforce</p>
              </div>
              <div className="bg-white dark:bg-neutral-700 p-4 rounded-lg text-center shadow-sm">
                <p className="font-medium text-neutral-700 dark:text-neutral-200">Microsoft Dynamics</p>
              </div>
            </div>
          </div>
        </div>
    ...
    "Data Management": (
      <>
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800 dark:text-white mb-4">Data Integration & Management Solutions</h2>
        </div>
        <div className="bg-[#F5F5F7] dark:bg-neutral-800 p-8 md:p-14 rounded-3xl mb-6">
          <p className="text-neutral-600 dark:text-neutral-400 text-base md:text-2xl font-sans max-w-3xl mx-auto">
            <span className="font-bold text-neutral-700 dark:text-neutral-200">
          ...
          <div className="mt-6 bg-white dark:bg-neutral-700 p-6 rounded-xl max-w-3xl mx-auto">
            <h3 className="font-bold text-neutral-700 dark:text-neutral-200 text-lg md:text-xl mb-3">Key Features:</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-neutral-600 dark:text-neutral-300">
              <div className="flex items-start">
                <span className="text-green-600 dark:text-green-400 mr-2">⚡</span>
        ...
        <div className="bg-[#F5F5F7] dark:bg-neutral-800 p-8 md:p-14 rounded-3xl mb-6">
          ...
          <div className="mt-6 max-w-3xl mx-auto">
            <h3 className="font-bold text-neutral-700 dark:text-neutral-200 text-lg md:text-xl mb-3">Data Governance Framework:</h3>
            <ul className="space-y-3 text-neutral-600 dark:text-neutral-400">
              <li className="flex items-start">
                <span className="text-blue-600 dark:text-blue-400 mr-2">•</span>
                <div>
                  <span className="font-semibold">Data Quality Management</span> - Implement validation rules, data cleansing, and enrichment processes
                </div>
              </li>
              <li className="flex items-start">
                <span className="text-blue-600 dark:text-blue-400 mr-2">•</span>
                <div>
                  <span className="font-semibold">Data Lineage & Auditing</span> - Track data flow from source to report for transparency and compliance
                </div>
              </li>
              <li className="flex items-start">
                <span className="text-blue-600 dark:text-blue-400 mr-2">•</span>
                <div>
                  <span className="font-semibold">Role-based Access Control</span> - Ensure data security with granular access permissions
                </div>
              </li>
              <li className="flex items-start">
                <span className="text-blue-600 dark:text-blue-400 mr-2">•</span>
                <div>
                  <span className="font-semibold">Metadata Management</span> - Maintain a centralized repository of data definitions and business rules
                </div>
              </li>
            </ul>
          </div>
        ...
        <div className="bg-[#F5F5F7] dark:bg-neutral-800 p-8 md:p-14 rounded-3xl mb-6">
          ...
          <div className="mt-8 max-w-3xl mx-auto">
            <h3 className="font-bold text-neutral-700 dark:text-neutral-200 text-lg md:text-xl mb-4">Workflow Automation Benefits:</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white dark:bg-neutral-700 p-6 rounded-xl shadow-sm">
                <h4 className="font-bold text-blue-600 dark:text-blue-400 text-lg mb-3">Efficiency Gains</h4>
                <p className="text-neutral-600 dark:text-neutral-300">Reduce manual effort and processing time by up to 80% with automated workflows.</p>
              </div>
              <div className="bg-white dark:bg-neutral-700 p-6 rounded-xl shadow-sm">
                <h4 className="font-bold text-blue-600 dark:text-blue-400 text-lg mb-3">Error Reduction</h4>
                <p className="text-neutral-600 dark:text-neutral-300">Minimize data errors and inconsistencies with automated validation and error handling.</p>
              </div>
              <div className="bg-white dark:bg-neutral-700 p-6 rounded-xl shadow-sm">
                <h4 className="font-bold text-blue-600 dark:text-blue-400 text-lg mb-3">Real-time Updates</h4>
                <p className="text-neutral-600 dark:text-neutral-300">Ensure your EPM applications always reflect the latest data with real-time synchronization.</p>
              </div>
              <div className="bg-white dark:bg-neutral-700 p-6 rounded-xl shadow-sm">
                <h4 className="font-bold text-blue-600 dark:text-blue-400 text-lg mb-3">Scalability</h4>
                <p className="text-neutral-600 dark:text-neutral-300">Easily scale your data processes as your business grows without additional overhead.</p>
              </div>
            </div>
          </div>
        </div>
    ...
    "Cloud Services": (
      <>
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800 dark:text-white mb-4">Cloud Migration & Optimization Services</h2>
        </div>
        <div className="bg-[#F5F5F7] dark:bg-neutral-800 p-8 md:p-14 rounded-3xl mb-6">
          <p className="text-neutral-600 dark:text-neutral-400 text-base md:text-2xl font-sans max-w-3xl mx-auto">
            <span className="font-bold text-neutral-700 dark:text-neutral-200">
          ...
          <div className="mt-6 bg-white dark:bg-neutral-700 p-6 rounded-xl max-w-3xl mx-auto">
            <h3 className="font-bold text-neutral-700 dark:text-neutral-200 text-lg md:text-xl mb-3">Migration Process:</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-neutral-600 dark:text-neutral-300">
              <div className="flex items-start">
                <span className="text-green-600 dark:text-green-400 mr-2">⚡</span>
        ...
        <div className="bg-[#F5F5F7] dark:bg-neutral-800 p-8 md:p-14 rounded-3xl mb-6">
          ...
          <div className="mt-6 max-w-3xl mx-auto">
            <h3 className="font-bold text-neutral-700 dark:text-neutral-200 text-lg md:text-xl mb-3">Hybrid Cloud Benefits:</h3>
            <ul className="space-y-3 text-neutral-600 dark:text-neutral-400">
              <li className="flex items-start">
                <span className="text-blue-600 dark:text-blue-400 mr-2">•</span>
                <div>
                  <span className="font-semibold">Flexibility</span> - Choose the best deployment model for each application
                </div>
              </li>
              <li className="flex items-start">
                <span className="text-blue-600 dark:text-blue-400 mr-2">•</span>
                <div>
                  <span className="font-semibold">Cost Efficiency</span> - Optimize costs by leveraging existing infrastructure
                </div>
              </li>
              <li className="flex items-start">
                <span className="text-blue-600 dark:text-blue-400 mr-2">•</span>
              ...
              <li className="flex items-start">
                <span className="text-blue-600 dark:text-blue-400 mr-2">•</span>
                <div>
                  <span className="font-semibold">Security</span> - Maintain control over sensitive data while benefiting from cloud innovation
                </div>
              </li>
            </ul>
          </div>
        ...
        <div className="bg-[#F5F5F7] dark:bg-neutral-800 p-8 md:p-14 rounded-3xl mb-6">
          ...
          <div className="mt-8 max-w-3xl mx-auto">
            <h3 className="font-bold text-neutral-700 dark:text-neutral-200 text-lg md:text-xl mb-4">Optimization Services:</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white dark:bg-neutral-700 p-6 rounded-xl shadow-sm">
                <h4 className="font-bold text-blue-600 dark:text-blue-400 text-lg mb-3">Performance Tuning</h4>
                <p className="text-neutral-600 dark:text-neutral-300">Optimize query performance, data loads, and system responsiveness.</p>
              </div>
              <div className="bg-white dark:bg-neutral-700 p-6 rounded-xl shadow-sm">
                <h4 className="font-bold text-blue-600 dark:text-blue-400 text-lg mb-3">Cost Management</h4>
                <p className="text-neutral-600 dark:text-neutral-300">Monitor and optimize cloud resource usage to control costs.</p>
              </div>
              <div className="bg-white dark:bg-neutral-700 p-6 rounded-xl shadow-sm">
                <h4 className="font-bold text-blue-600 dark:text-blue-400 text-lg mb-3">Security Updates</h4>
                <p className="text-neutral-600 dark:text-neutral-300">Implement the latest security patches and best practices.</p>
              </div>
              <div className="bg-white dark:bg-neutral-700 p-6 rounded-xl shadow-sm">
                <h4 className="font-bold text-blue-600 dark:text-blue-400 text-lg mb-3">Feature Adoption</h4>
                <p className="text-neutral-600 dark:text-neutral-300">Leverage new features and capabilities as they become available.</p>
              </div>
            </div>
          </div>
        </div>
...
"Reporting": (
  <>
    <div className="text-center mb-8">
      {svgMap["Reporting"]}
      <h2 className="text-2xl md:text-3xl font-bold text-gray-800 dark:text-white mb-4">Custom Reporting & Analytics Solutions</h2>
    </div>
    <div className="bg-[#F5F5F7] dark:bg-neutral-800 p-8 md:p-14 rounded-3xl mb-6">
      <p className="text-neutral-600 dark:text-neutral-400 text-base md:text-2xl font-sans max-w-3xl mx-auto">
        <span className="font-bold text-neutral-700 dark:text-neutral-200">
    ...
    <div className="bg-[#F5F5F7] dark:bg-neutral-800 p-8 md:p-14 rounded-3xl mb-6">
      ...
      <div className="mt-6 max-w-3xl mx-auto">
        <h3 className="font-bold text-neutral-700 dark:text-neutral-200 text-lg md:text-xl mb-3">Visualization Capabilities:</h3>
        <ul className="space-y-3 text-neutral-600 dark:text-neutral-400">
          <li className="flex items-start">
            <span className="text-blue-600 dark:text-blue-400 mr-2">•</span>
            <div>
              <span className="font-semibold">Dynamic Dashboards</span> - Real-time updates with drag-and-drop functionality
            </div>
          </li>
          <li className="flex items-start">
            <span className="text-blue-600 dark:text-blue-400 mr-2">•</span>
            <div>
              <span className="font-semibold">Predictive Analytics</span> - Forecast trends and identify opportunities
            </div>
          </li>
          <li className="flex items-start">
            <span className="text-blue-600 dark:text-blue-400 mr-2">•</span>
            <div>
              <span className="font-semibold">Geospatial Mapping</span> - Visualize data on maps for location-based insights
            </div>
          </li>
          <li className="flex items-start">
            <span className="text-blue-600 dark:text-blue-400 mr-2">•</span>
            <div>
              <span className="font-semibold">Custom Themes</span> - Match your organization's branding and style
            </div>
          </li>
        </ul>
      </div>
    ...
    <div className="bg-[#F5F5F7] dark:bg-neutral-800 p-8 md:p-14 rounded-3xl mb-6">
      ...
      <div className="mt-8 max-w-3xl mx-auto">
        <h3 className="font-bold text-neutral-700 dark:text-neutral-200 text-lg md:text-xl mb-4">Supported Data Sources:</h3>
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          <div className="bg-white dark:bg-neutral-700 p-4 rounded-lg text-center shadow-sm">
            <p className="font-medium text-neutral-700 dark:text-neutral-200">Oracle ERP Cloud</p>
          </div>
          ...
          <div className="bg-white dark:bg-neutral-700 p-4 rounded-lg text-center shadow-sm">
            <p className="font-medium text-neutral-700 dark:text-neutral-200">Google BigQuery</p>
          </div>
        </div>
      </div>
    </div>
...
"Support": (
  <>
    <div className="text-center mb-8">
      {svgMap["Support"]}
      <h2 className="text-2xl md:text-3xl font-bold text-gray-800 dark:text-white mb-4">Comprehensive Training & Support Services</h2>
    </div>
    <div className="bg-[#F5F5F7] dark:bg-neutral-800 p-8 md:p-14 rounded-3xl mb-6">
      <p className="text-neutral-600 dark:text-neutral-400 text-base md:text-2xl font-sans max-w-3xl mx-auto">
        <span className="font-bold text-neutral-700 dark:text-neutral-200">
      ...
      <div className="mt-6 bg-white dark:bg-neutral-700 p-6 rounded-xl max-w-3xl mx-auto">
        <h3 className="font-bold text-neutral-700 dark:text-neutral-200 text-lg md:text-xl mb-3">Training Programs:</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-neutral-600 dark:text-neutral-300">
          <div className="flex items-start">
            <span className="text-green-600 dark:text-green-400 mr-2">⚡</span>
    ...
    <div className="bg-[#F5F5F7] dark:bg-neutral-800 p-8 md:p-14 rounded-3xl mb-6">
      ...
      <div className="mt-6 max-w-3xl mx-auto">
        <h3 className="font-bold text-neutral-700 dark:text-neutral-200 text-lg md:text-xl mb-3">Support Services:</h3>
        <ul className="space-y-3 text-neutral-600 dark:text-neutral-400">
          <li className="flex items-start">
            <span className="text-blue-600 dark:text-blue-400 mr-2">•</span>
            <div>
              <span className="font-semibold">24/7 Technical Support</span> - Round-the-clock assistance for critical issues
            </div>
          </li>
          <li className="flex items-start">
            <span className="text-blue-600 dark:text-blue-400 mr-2">•</span>
            <div>
              <span className="font-semibold">System Health Checks</span> - Regular performance and security audits
            </div>
          </li>
          <li className="flex items-start">
            <span className="text-blue-600 dark:text-blue-400 mr-2">•</span>
            <div>
              <span className="font-semibold">Patch Management</span> - Timely updates and bug fixes
            </div>
          </li>
          <li className="flex items-start">
            <span className="text-blue-600 dark:text-blue-400 mr-2">•</span>
            <div>
              <span className="font-semibold">User Support Portal</span> - Self-service resources and FAQs
            </div>
          </li>
        </ul>
      </div>
    ...
    <div className="bg-[#F5F5F7] dark:bg-neutral-800 p-8 md:p-14 rounded-3xl mb-6">
      ...
      <div className="mt-8 max-w-3xl mx-auto">
        <h3 className="font-bold text-neutral-700 dark:text-neutral-200 text-lg md:text-xl mb-4">Documentation & Resources:</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white dark:bg-neutral-700 p-6 rounded-xl shadow-sm">
            <h4 className="font-bold text-blue-600 dark:text-blue-400 text-lg mb-3">User Guides</h4>
            <p className="text-neutral-600 dark:text-neutral-300">Step-by-step instructions for end-users and administrators.</p>
          </div>
          <div className="bg-white dark:bg-neutral-700 p-6 rounded-xl shadow-sm">
            <h4 className="font-bold text-blue-600 dark:text-blue-400 text-lg mb-3">Technical Documentation</h4>
            <p className="text-neutral-600 dark:text-neutral-300">Detailed technical specifications and architecture diagrams.</p>
          </div>
          <div className="bg-white dark:bg-neutral-700 p-6 rounded-xl shadow-sm">
            <h4 className="font-bold text-blue-600 dark:text-blue-400 text-lg mb-3">Best Practices</h4>
            <p className="text-neutral-600 dark:text-neutral-300">Proven strategies for optimizing system performance.</p>
          </div>
          <div className="bg-white dark:bg-neutral-700 p-6 rounded-xl shadow-sm">
            <h4 className="font-bold text-blue-600 dark:text-blue-400 text-lg mb-3">Video Tutorials</h4>
            <p className="text-neutral-600 dark:text-neutral-300">On-demand video resources for quick learning.</p>
          </div>
        </div>
      </div>
    </div>
...
const data = [
  {
    ...
    content: <DummyContent serviceType="Implementation" />,
  },
  {
    ...
    content: <DummyContent serviceType="Financial Solutions" />,
  },
  {
    ...
    content: <DummyContent serviceType="Data Management" />,
  },
  {
    ...
    content: <DummyContent serviceType="Cloud Services" />,
  },
  {
    category: "Reporting",
    ...
    content: <DummyContent serviceType="Reporting" />,
  },
  {
    category: "Support",
    ...
    content: <DummyContent serviceType="Support" />,
  },
];
