        ...
        <>
          ...
          <div className="bg-secondary-700 p-8 md:p-14 rounded-3xl mb-6">
            ...
            <div className="mt-6 bg-white dark:bg-primary-text-primary-300 p-6 rounded-xl max-w-3xl mx-auto">
              ...
              <ul className="space-y-3 text-primary-400 text-base md:text-xl font-grotesk">
                <li className="flex items-start">
                  <span className="text-blue-400 mr-2">✓</span>
          ...
          <div className="bg-secondary-700 p-8 md:p-14 rounded-3xl mb-6">
            ...
            <div className="mt-6 bg-white dark:bg-primary-text-primary-300 p-6 rounded-xl max-w-3xl mx-auto">
              ...
              <ul className="space-y-3 text-on-dark text-base md:text-xl font-grotesk">
                <li className="flex items-start">
                  <span className="text-blue-400 mr-2 ">✓</span>
                  <span className="text-primary-400">Seamless integration with ERP, CRM, and other systems</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">✓</span>
                  <span className="text-primary-400">Automated data validation and cleansing</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">✓</span>
                  <span className="text-primary-400">Real-time data synchronization</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">✓</span>
                  <span className="text-primary-400">Scalable data architecture for growing needs</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="bg-secondary-700 p-8 md:p-14 rounded-3xl mb-6">
            ...
            <div className="mt-6 bg-white dark:bg-primary-text-primary-300 p-6 rounded-xl max-w-3xl mx-auto">
              ...
              <ul className="space-y-3 text-on-dark text-base md:text-xl font-grotesk">
                <li className="flex items-start">
                  <span className="text-blue-400 mr-2">✓</span>
                  <span className="text-primary-400">Comprehensive assessment of current environment</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">✓</span>
                  <span className="text-primary-400">Customized migration plan and timeline</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">✓</span>
                  <span className="text-primary-400">Data migration and validation</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">✓</span>
                  <span className="text-primary-400">Post-migration support and optimization</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="bg-secondary-700 p-8 md:p-14 rounded-3xl mb-6">
            ...
            <div className="mt-6 bg-white dark:bg-primary-text-primary-300 p-6 rounded-xl max-w-3xl mx-auto">
              ...
              <ul className="space-y-3 text-on-dark text-base md:text-xl font-grotesk">
                <li className="flex items-start">
                  <span className="text-blue-400 mr-2">✓</span>
                  <span className="text-primary-400">Interactive dashboards with real-time data</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">✓</span>
                  <span className="text-primary-400">Customizable reports for different user roles</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">✓</span>
                  <span className="text-primary-400">Drill-down capabilities for detailed analysis</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">✓</span>
                  <span className="text-primary-400">Automated report generation and distribution</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="bg-secondary-700 p-8 md:p-14 rounded-3xl mb-6">
            ...
            <div className="mt-6 bg-white dark:bg-primary-text-primary-300 p-6 rounded-xl max-w-3xl mx-auto">
              ...
              <ul className="space-y-3 text-on-dark text-base md:text-xl font-grotesk">
                <li className="flex items-start">
                  <span className="text-blue-400 mr-2">✓</span>
                  <span className="text-primary-400">End-user training for day-to-day operations</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">✓</span>
                  <span className="text-primary-400">Administrator training for system management</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">✓</span>
                  <span className="text-primary-400">Advanced analytics and reporting training</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">✓</span>
                  <span className="text-primary-400">Custom workshops for specific business needs</span>
                </li>
              </ul>
            </div>
          </div>
