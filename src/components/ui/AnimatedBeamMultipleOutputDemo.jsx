...
const Circle = forwardRef(({ className, children }, ref) => (
  <div
    ref={ref}
    className={cn(
      "z-10 flex size-11 items-center justify-center rounded-full border-2 border-border bg-blue-400 p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
      className
    )}
  >
    {children}
    ...
    >
      <div className="flex size-full max-w-lg flex-row items-stretch justify-between gap-10">
        <div className="flex flex-col justify-center gap-2">
          <Circle ref={div1Ref}><User/></Circle>
          <Circle ref={div2Ref}><User/></Circle>
          <Circle ref={div3Ref}><User/></Circle>
          <Circle ref={div4Ref}><User/></Circle>
          <Circle ref={div5Ref}><User/></Circle>
        </div>
        <div className="flex flex-col justify-center">
          <Circle ref={div6Ref} className="size-16"><User/></Circle>
        </div>
        <div className="flex flex-col justify-center">
          <Circle ref={div7Ref}><User/></Circle>
        </div>
      </div>
