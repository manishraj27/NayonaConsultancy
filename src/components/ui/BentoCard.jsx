...
function BentoCard({ item, index, currentPath }) {
  ...
  const submenuVariants = {
    ...
    exit: { opacity: 0, y: -10, height: 0, transition: { duration: 0.2, ease: "easeInOut" } },
  };
  ...
  return (
    <motion.div
      ...
      } rounded-3xl bg-secondary-200 border border-gray-100/50 transition-all duration-300 ease-out shadow-sm hover:shadow-md ${
    ...
    >
      ...
      >
        <div className="flex items-center justify-between mb-3">
          ...
          {hasSubmenu && (
            <motion.div
              animate={{ rotate: isActive ? 90 : 0, color: isActive ? "#4B5563" : "#9CA3AF" }}
